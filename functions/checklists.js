...
const INTERNAL_CHECKLIST = {
  ...
  milestones: [
    { id: "int_ms_1", name: "1. Scope, Design & CAD Release", description: "Finalize CAD, BOM, and cross-functional review.", color: "#00C9A7", gating: true, checklist: [
      ...
      g("int_1_2",   "Mounting interfaces validated for station and line compatibility from actual line visit by TPM / SA", "HDE, TPM, SA"),
      ...
      g("int_1_5_a","Confirm final configuration including optics (WD, FOV), line name, image name/types clearly outlined in scoping document", "SA"),
      g("int_1_6",   "Confirm optics and hardware compatible with factory station design and process flow (ergonomics, mounting, material & process flow, product imaging intent)", "SA, HDE"),
    ], links: [], signatures: [] },
    ...
    { id: "int_ms_3", name: "3. Custom Parts, Procurement & Hardware Fabrication", description: "Identify, order, and track all parts.", color: "#F59E0B", gating: true, checklist: [
      g("int_3_1", "Mounting design finalized by TPM / SA and order parts that meet FOV and working distance requirements, adding reasonable buffer for changes", "TPM, SA"),
    ...
    { id: "int_ms_4", name: "4. System, Software, Data & MES Integration Readiness", description: "Validate compute, network, power, and integration requirements.", color: "#A855F7", gating: true, checklist: [
      ...
      g("int_4_2_a","Provision and deploy computers", "TPM, FDE"),
      g("int_4_2",   "Extra hardware scoped and prepped in advance of shipment, including calibration boards that are suitable for product imaging size", "TPM, FDE"),
      ...
      g("int_4_6",   "Create new or use existing Lastpass, configure Station SOP on station hardware before shipment / deployment", "TPM, FDE"),
    ], links: [], signatures: [] },
    { id: "int_ms_5", name: "5. Deployment Planning & Shipment", description: "Define location, schedule, logistics, and documentation.", color: "#0284C7", gating: true, checklist: [
      ...
      g("int_6_2", "Create Webapp project and fill: Station SOP, fixture details, manage lines, reference images, org name for MES (whatever applicable before and after deployment)", "TPM"),
      g("int_6_3", "Installation procedure documented", "TPM"),
      g("int_6_4", "Daily deployment schedule established, accounting for buffer in case of unknown unknowns", "TPM"),
...
const TABLE_TEMPLATES = [
  {
    // Matches StationKits sheet: row-per-station, full hardware attribute matrix from Excel (63 attributes)
    id: "pd_station_kits", name: "Station Kits", type: "table", accessLevel: "open",
    columns: [
      { key: "station_num",           label: "Station #",                            width: 100 },
      { key: "line",                  label: "Line Name",                            width: 100 },
      { key: "station_name",          label: "Station Name",                         width: 100 },
      { key: "fixture_name",          label: "Fixture Name",                         width: 100 },
      { key: "computer_service_tag",  label: "Computer ServiceTag",                  width: 100 },
      { key: "mac_address",           label: "MAC Address",                          width: 100 },
      { key: "computer_sn",           label: "Computer SN",                          width: 100 },
      { key: "computer_deployed",     label: "Computer Deployed?",                   width: 100, type: "boolean" },
      { key: "keyboard",              label: "Keyboard",                             width: 100, type: "boolean" },
      { key: "mouse",                 label: "Mouse",                                width: 100, type: "boolean" },
      { key: "usb_button",            label: "USB Button",                           width: 100, type: "boolean" },
      { key: "ethernet_cable",        label: "Ethernet Cable",                       width: 100, type: "boolean" },
      { key: "power_cable",           label: "Power Cable",                          width: 100, type: "boolean" },
      { key: "barcode_scanner",       label: "BarCode Scanner",                      width: 100, type: "boolean" },
      { key: "barcode_scanner_sn",    label: "BarCode Scanner SN",                   width: 100 },
      { key: "monitor",               label: "Monitor",                              width: 100, type: "boolean" },
      { key: "monitor_sn",            label: "Monitor SN",                           width: 100 },
      { key: "hdmi_dp_cable",         label: "HDMI to DP Cable",                     width: 100, type: "boolean" },
      { key: "cameras_present",       label: "Cameras",                              width: 100, type: "boolean" },
      { key: "camera_1_sn",           label: "Camera #1 SN",                         width: 100 },
      { key: "no_cameras",            label: "No. Cameras",                          width: 100 },
      { key: "camera_type",           label: "Camera Type",                          width: 100 },
      { key: "no_camera_brackets",    label: "No. Camera Brackets",                  width: 100 },
      { key: "camera_brackets",       label: "Camera Brackets",                      width: 100, type: "boolean" },
      { key: "camera_bracket_notch",  label: "Camera Bracket Notch #",               width: 100 },
      { key: "camera_usb_cable",      label: "Camera USB Cable",                     width: 100, type: "boolean" },
      { key: "lenses_present",        label: "Lenses",                               width: 100, type: "boolean" },
      { key: "lens_1_type",           label: "Lens #1 Type",                         width: 100 },
      { key: "lens_1_sn",             label: "Lens #1 SN",                           width: 100 },
      { key: "no_leds",               label: "No. LEDs/Type",                        width: 100 },
      { key: "uv_light",              label: "UV Light",                             width: 100 },
      { key: "uv_light_notch",        label: "UV Light Rotational Notch #",          width: 100 },
      { key: "leds",                  label: "LEDs",                                 width: 100, type: "boolean" },
      { key: "white_light_notch",     label: "White Light Rotational Notch #",       width: 100 },
      { key: "no_led_cables",         label: "No. LED Cables/Length",                width: 100 },
      { key: "led_cables",            label: "LED Cables",                           width: 100, type: "boolean" },
      { key: "led_brackets",          label: "LED Brackets",                         width: 100, type: "boolean" },
      { key: "led_controller_sn",     label: "LED Controller SN",                    width: 100 },
      { key: "light_ctrl_automated",  label: "Light Controller (Wordop, automated)", width: 100, type: "boolean" },
      { key: "light_ctrl_manual",     label: "Light Controller (Wordop, manual)",    width: 100, type: "boolean" },
      { key: "manual_controller_sn",  label: "Manual Controller SN",                 width: 100 },
      { key: "led_white_intensity",   label: "LED White Intensity",                  width: 100 },
      { key: "uv_light_intensity",    label: "UV Light Intensity",                   width: 100 },
      { key: "ledc_power_cable",      label: "LEDC Power Cable",                     width: 100, type: "boolean" },
      { key: "led_ctrl_ext_cables",   label: "4x LED Controller Ext. Cables",        width: 100, type: "boolean" },
      { key: "station_sn",            label: "Station SN",                           width: 100 },
      { key: "andon_stack_light",     label: "Andon/Stack Light",                    width: 100, type: "boolean" },
      { key: "andon_stack_bracket",   label: "Andon/Stack Bracket",                  width: 100, type: "boolean" },
      { key: "keyboard_mouse_tray",   label: "Keyboard/Mouse Tray",                  width: 100, type: "boolean" },
      { key: "monitor_bracket",       label: "Monitor Bracket",                      width: 100, type: "boolean" },
      { key: "barcode_scanner_mount", label: "Barcode Scanner Mount",                width: 100, type: "boolean" },
      { key: "cable_ties",            label: "Cable Ties & Wrap",                    width: 100, type: "boolean" },
      { key: "baseboard_3d_nest",     label: "Baseboard 3D Printed Nest",            width: 100, type: "boolean" },
      { key: "mainboard_3d_nest",     label: "Mainboard 3D Printed Nest",            width: 100, type: "boolean" },
      { key: "baseboard_cnc_nest",    label: "Baseboard CNC Machined Nest",          width: 100, type: "boolean" },
      { key: "mainboard_cnc_nest",    label: "Mainboard CNC Machined Nest",          width: 100, type: "boolean" },
      { key: "power_converter",       label: "Power Converter & Cable (Brazil) 2x",  width: 100, type: "boolean" },
      { key: "instrumental_sign",     label: "Instrumental Sign [optional]",         width: 100, type: "boolean" },
      { key: "nbr_cable",             label: "NBR 14136-to-C13 10A/250V",            width: 100, type: "boolean" },
      { key: "nema_adapter",          label: "4x NEMA-to-NBR Adapter",               width: 100, type: "boolean" },
      { key: "brazil_power_cord",     label: "4x Brazil Power Cord - 6 ft",          width: 100, type: "boolean" },
      { key: "ship_date",             label: "Ship Date",                            width: 100, type: "date" },
      { key: "notes",                 label: "Notes",                                width: 200 },
    ], rows: [],
  },
  {
    // Matches InFactoryInstall sheet: network config + install confirmation per station
  ...
  {
    // Matches CameraSettings sheet: one row per camera/station, all optical + trigger params
  ...
  {
    // Matches LED Settings sheet: L1–L4 brightness + L1–L4 type per station (controller flag)
  ...
  {
    // Matches SOP_Plan sheet exactly
  ...
  {
    // Matches MES_StationPlan sheet exactly, including SFC status booleans
